...
<div class="container-main section-pad">
    ...
    <section class="mb-5 section-divider pt-5" aria-label="Education">
        ...
        <div class="timeline">
            ...
            <div class="timeline-item" data-animate>
                <div class="timeline-card">
                    <div class="timeline-date"><?= Sanitizer::output($diploma['first_year']) ?> — <?= Sanitizer::output($diploma['last_year']) ?></div>
                    <h3 class="timeline-role"><?= Sanitizer::output($diploma['name']) ?></h3>
                    <p class="timeline-company">
                        <i class="fa-solid fa-building-columns fa-xs" aria-hidden="true"></i>
                        <?= Sanitizer::output($diploma['issuing_organization']) ?>
                    </p>
                </div>
            </div>
            <?php endforeach; ?>
    ...
    <!-- ── CERTIFICATIONS ─────────────────────────────────────── -->
    <section class="mb-5 section-divider pt-5" aria-label="Certifications">
        <h2 class="resume-section-title">
            <i class="fa-solid fa-certificate" aria-hidden="true"></i>
            <?= t('resume.sections.certifications') ?? 'Certificaciones' ?>
        </h2>
        <div class="timeline">
            ...
            <div class="timeline-item" data-animate>
                <div class="timeline-card">
                    ...
                    <p class="timeline-company">
                        <i class="fa-solid fa-award fa-xs" aria-hidden="true"></i>
